...
class AddNewValueCarbo extends StatelessWidget {
              ...
              child: Column(
                ...
                children: [
                  defultFormField(
                    ...
                    validate: (value) {
                      if (value!.isEmpty) {
                        return 'please enter carbohydrates value';
                      }
                  ...
                  ConditionalBuilder(
                    condition: State is! CarboStartAddToGoogleFitSuccessState,
                    builder: (context) => defulteButton(
                      function: () {
                        if (formKey.currentState!.validate()) {
                          ...
                          //
                          cubit.addCarboToGooglefit(
                            carbo: double.parse(titleController.text),
                            date: timeDate,
                          );
